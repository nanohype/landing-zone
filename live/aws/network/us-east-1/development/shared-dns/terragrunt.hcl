...
inputs = {
  # One private zone shared to every development cluster VPC via the Route53 Profile. external-dns in
  ...
  # RAM-share the Profile to the workload-development account, which associates it with its cluster
