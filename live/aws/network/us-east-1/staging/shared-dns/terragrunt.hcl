...
inputs = {
  # One private zone shared to every staging cluster VPC via the Route53 Profile. external-dns in
  ...
  # RAM-share the Profile to the workload-staging account, which associates it with its cluster
