...
inputs = {
  ...
  # never hand-copies it. This leaf demonstrates the enterprise adopt shape; every workload
  # environment runs dns_mode = create with its own private_zones instead, which is what lets an
  # environment come up without the network account existing. See README.md at the root of this tree.
  dns_mode   = "adopt"
