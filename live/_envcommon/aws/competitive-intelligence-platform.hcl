/**
 * competitive-intelligence-platform — env-shared inputs and dependency
 * wiring.
 *
 * Per-env overrides go in
 * live/aws/<account>/<region>/<env>/competitive-intelligence-platform/terragrunt.hcl.
 *
 ...
 * cluster security group for the Aurora ingress rule.
 */

terraform {
  source = "${dirname(find_in_parent_folders("cloud.hcl"))}/../..//components/aws/competitive-intelligence-platform"
}
