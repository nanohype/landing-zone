output "irsa_role_arn" {
  description = "IAM role ARN for the competitive-intelligence ServiceAccount. The eks-agent-platform operator reconciles this onto the chart's ServiceAccount's eks.amazonaws.com/role-arn annotation. Wired to the chart's aws.platformRoleArn."
  value       = module.competitive_intelligence_irsa.iam_role_arn
}
